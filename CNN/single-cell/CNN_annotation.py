...
log2FC = dat['avg_logFC'].to_numpy(dtype = np.float32)
...
test_log2FC = test['avg_logFC'].to_numpy(dtype = np.float32)
...
for epoch in range(epochs):
    ...
    if epoch % 4 == 0:
        ...
        r2_list.append(r2.correlation)
        np.savetxt("./result/spearman.csv", r2_list, delimiter=",")
