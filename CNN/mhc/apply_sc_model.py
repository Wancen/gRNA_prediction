...
resultdir = '/proj/yunligrp/users/tianyou/gRNA/result/single-cell/cross_apply/'
modeldir = '/proj/yunligrp/users/tianyou/gRNA/result/single-cell/models/'
batch_size = 512
epochs = 400
lr = 0.00005
ngpu=1
...
ckptPATH = os.path.join(modeldir,'sc-binary-BCE-seqannot-fold'+str(fold)+'-'+args.date+'.pth')
...
k562_PD.to_csv(os.path.join(resultdir,'sc-binary-BCE-seqannot-fold'+str(fold)+'-test-k562.csv'))
...
npc_PD.to_csv(os.path.join(resultdir,'sc-binary-BCE-seqannot-fold'+str(fold)+'-test-npc.csv'))
...
ipsc_PD.to_csv(os.path.join(resultdir,'sc-binary-BCE-seqannot-fold'+str(fold)+'-test-ipsc.csv'))
