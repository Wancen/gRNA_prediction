...
ckptPATH = resultdir + '/models/gRNA_binary-'+grp+'-BCE-seq-allannot-fold'+str(fold)+'-Nov28.pth'
...
PD.to_csv(resultdir + '/gRNA_binary-'+grp+'-BCE-seq-allannot-fold'+str(fold)+'-Nov28.csv')
